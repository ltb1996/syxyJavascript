...
```bash
$ node
> console.log('Hello, syxy Node.js!');
Hello, syxy Node.js!
```
...
```javascript
// lib.js
module.exports = 'Hello, syxy Node.js!';

// app.js
let message = require('./lib');
console.log(message);  // 输出 'Hello, syxy Node.js!'
```

在上面的例子中，我们创建了两个 `js` 文件 `lib.js` 和 `app.js`，你可以在命令行输入 `node app.js`，会得到输出 'Hello, syxy Node.js!'。
